...
export default function FiltrosPersonal({
  ...
  return (
    <>
    <div className="p-3 border-b border-[var(--c-bg-elev-2)] space-y-3">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full rounded-lg border border-[var(--c-line)] pl-9 pr-3 py-1.5 text-sm text-[var(--c-text)] placeholder-[var(--c-text-faint)] focus:outline-none focus:ring-2 focus:ring-[var(--c-blue)] focus:border-transparent transition"
        />
      </div>
